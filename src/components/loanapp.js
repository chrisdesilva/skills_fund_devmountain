				...
				<form className={formName} onSubmit={handleSubmit}>
					...
					{multiplePrograms && (
                        ...
                        <p className={programInfo.active.program3 ? activeClass : inactiveClass} onClick={() => handleProgramSelect(3)}>Web Development After-Hours</p> */}
							...
							<p
								className={programInfo.active.program5 ? activeClass : inactiveClass}
								onClick={() => handleProgramSelect(5)}
							>
								UX Design After-Hours
							</p>
							<p
								className={programInfo.active.program6 ? activeClass : inactiveClass}
								onClick={() => handleProgramSelect(6)}
							>
								iOS Development Immersive
							</p>
							<p
								className={programInfo.active.program7 ? activeClass : inactiveClass}
								onClick={() => handleProgramSelect(7)}
							>
								Software QA Immersive
							</p>
						</div>
					)}
